...
<body>
	<table border="1">
		<caption>
			<strong>访问Struts2的命名对象：parameters、request、session、application</strong>
		</caption>
		<tr>
			<th>OGNL表达式</th>
			<th>java代码</th>
	...
	<table border="1">
		...
		<tr>
			...
			<td>((OgnlAction)ActionContext.getContext().getValueStack().peek()).getPersons().get(2).getAliases()[2]</td>
